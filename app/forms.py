...
class RegistrationForm(FlaskForm):
    ...
    email = StringField('Email', validators = [DataRequired(message = "Please Enter An Email Address"), Email("Please Enter A Valid Email Address")])
    password = PasswordField('Password', validators = [DataRequired("Please Enter A Secure Password")])
    confirm = PasswordField(
        'Confirm Password', validators = [DataRequired("Please Confirm Password"), EqualTo('password', message = "Passwords must match")])
    accept_tos = BooleanField('I Accept The Terms Of Service', validators = [DataRequired("You Must Accept The Terms Of Service")])
